...
output "agent_gateway-1_agent_gateway_id" {
  description = "The full resource ID of the Agent Gateway."
  value       = module.agent_gateway-1.agent_gateway_id
}
output "agent_gateway-1_mtls_endpoint" {
  description = "The mTLS Endpoint associated with this Agent Gateway for agent connections."
  value       = module.agent_gateway-1.mtls_endpoint
}
